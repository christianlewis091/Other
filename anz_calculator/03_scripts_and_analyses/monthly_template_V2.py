...
summary3 = pd.DataFrame({"Income": income, "Outgoing": transactions, "Saved": amount_saved}, index = [0])
...
"""
Version 2 began October 1, 2022.
Changes made to this version: results were writing to excel twice. I kept the second one. 
I also added a new tab in the writing to excel process. This includes global summary of the months' data
"""
