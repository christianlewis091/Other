...
anz = pd.read_csv(r'G:\My Drive\Money\BudgetAnalysis\python_input_files\{}.csv'.format(name))
...
plt.savefig(r'G:/My Drive/Money/BudgetAnalysis/python_pie_charts/{}_Results.png'.format(name),
