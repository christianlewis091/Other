...
def executeList():
    ...
    final_list['Grocer'] = -999
    print(final_list)
    bininn = ['sugar','AP flour','salt','brown sugar','nutmeg','cardamom']
    for i in range(0, len(bininn)):
        theitem = bininn[i]
        final_list = final_list.loc[final_list['Unit_of_Measure'] > 1, 'Grocer'] = 'BinInn'
